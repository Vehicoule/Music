...
use streambox_core::ffi::{
    streambox_echo_json, streambox_favorites_add_json, streambox_favorites_list_json,
    streambox_favorites_remove_json, streambox_health_json, streambox_platform_info_json,
